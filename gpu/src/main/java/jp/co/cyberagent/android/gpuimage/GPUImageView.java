...
import jp.co.cyberagent.android.gpuimage.util.CLogger;
...
public class GPUImageView extends FrameLayout {
     ...
     */
    @Deprecated
    public void setUpCamera(final Camera camera, Camera.PreviewCallback previewCallback) {
        gpuImage.setUpCamera(camera, previewCallback);
    }
    ...
    public void setUpCamera(final Camera camera, final int degrees, final boolean flipHorizontal,
                            final boolean flipVertical, Camera.PreviewCallback previewCallback) {
        gpuImage.setUpCamera(camera, degrees, flipHorizontal, flipVertical, previewCallback);
    }
    ...
    public void setDrawVideoListener(GPUImageRenderer.DrawVideoListener drawVideoListener) {
        if (gpuImage != null) {
            gpuImage.setDrawVideoListener(drawVideoListener);
        }
    }
